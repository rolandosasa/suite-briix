...
@section ('title', trans('labels.briix.access.users.management') . ' | ' . trans('labels.briix.access.users.deleted'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.briix.access.users.deleted') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.briix.access.users.deleted') }}</h3>
		...
		$(function() {
            ...
            $("body").on("click", "a[name='delete_user_perm']", function(e) {
                ...
                swal({
                    ...
                    text: "{{ trans('strings.briix.access.users.delete_user_confirm') }}",
                    type: "warning",
            ...
            $("body").on("click", "a[name='restore_user']", function(e) {
                ...
                swal({
                    title: "{{ trans('strings.briix.general.are_you_sure') }}",
                    text: "{{ trans('strings.briix.access.users.restore_user_confirm') }}",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#DD6B55",
                    confirmButtonText: "{{ trans('strings.briix.general.continue') }}",
