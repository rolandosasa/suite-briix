...
@section ('title', trans('labels.briix.access.users.management') . ' | ' . trans('labels.briix.access.users.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.briix.access.users.management') }}
        <small>{{ trans('labels.briix.access.users.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($user, ['route' => ['briix.access.user.update', $user], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.briix.access.users.edit') }}</h3>
