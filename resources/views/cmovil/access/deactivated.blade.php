...
@section ('title', trans('labels.cmovil.access.users.management') . ' | ' . trans('labels.cmovil.access.users.deactivated'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.cmovil.access.users.deactivated') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.cmovil.access.users.deactivated') }}</h3>
