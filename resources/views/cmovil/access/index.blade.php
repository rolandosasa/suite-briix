...
@section ('title', trans('labels.cmovil.access.users.management'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.cmovil.access.users.active') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.cmovil.access.users.active') }}</h3>
                ...
                <table id="users-table" class="table table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.cmovil.access.users.table.enterprise') }}</th>
