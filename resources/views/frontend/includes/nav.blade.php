<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            ...
            {{ link_to_route('cpanel.dashboard', app_name(), [], ['class' => 'navbar-brand']) }}
        </div><!--navbar-header-->

        <div class="collapse navbar-collapse" id="frontend-navbar-collapse">
            <ul class="nav navbar-nav">
                <li>{{ link_to_route('frontend.index', trans('navs.general.home')) }}</li>
                <li>{{ link_to_route('frontend.products', trans('navs.frontend.macros')) }}</li>
            </ul>
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>{{ link_to_route('cpanel.dashboard', trans('navs.frontend.user.administration')) }}</li>
                            @endauth
