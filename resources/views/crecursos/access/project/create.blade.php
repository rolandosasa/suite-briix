...
@section ('title', trans('labels.crecursos.access.project.management') . ' | ' . trans('labels.crecursos.access.project.create'))
...
@section('page-header')
  <h1>
      ...
      <small>{{ trans('labels.crecursos.access.project.create') }}</small>
  </h1>
@endsection

@section('content')
  {{ Form::open(['route' => 'crecursos.access.project.store', 'class' => 'form-horizontal', 'project' => 'form', 'method' => 'post', 'id' => 'create-project']) }}
