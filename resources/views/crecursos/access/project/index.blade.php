...
@section ('title', trans('labels.crecursos.access.project.management') . ' | ' . trans('labels.crecursos.access.project.main'))
...
@section('page-header')
	 <h1>
		...
		<small>{{ trans('labels.crecursos.access.project.active') }}</small>
	</h1>
@endsection
...
@section('content')
	<div class="box box-success">
		<div class="box-header with-border">
			<h3 class="box-title">{{ trans('labels.crecursos.access.project.management') }}</h3>
...
@section('after-scripts-end')
  ...
  <script>
    ...
    $("body").on("click", "a[name='delete_project']", function(e) {
      e.preventDefault();
      var linkURL = $(this).attr("href");

      swal({
          title: "{{ trans('strings.backend.general.are_you_sure') }}",
          text: "{{ trans('strings.crecursos.access.project.delete_confirm') }}",
          type: "warning",
