...
@section ('title', trans('labels.crecursos.access.personal.management') . ' | ' . trans('labels.crecursos.access.personal.main'))
...
@section('page-header')
	 <h1>
		...
		<small>{{ trans('labels.crecursos.access.personal.active') }}</small>
	</h1>
@endsection
