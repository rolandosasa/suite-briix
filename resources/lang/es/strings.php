...
return [
    ...
    */
    'briix' => [
        'access' => [
            ...
            'enterprises' => [
                'delete_enterprise_confirm' => 'Estas seguro de querer eliminar esta Empresa de forma permanente? Esto puede producir un error grave en aquéllas partes de la aplicación que hagan referencia al mismo. Proceda con cautela. Esta operación no puede ser revertida.',
            ...
            'contracts' => [
                'delete_contract_confirm' => 'Estas seguro de querer eliminar este Contrato de forma permanente? Esto puede producir un error grave en aquéllas partes de la aplicación que hagan referencia al mismo. Proceda con cautela. Esta operación no puede ser revertida.',
                'if_confirmed_off' => '(Si la confirmación esta desactivada)',
                'restore_enterprise_confirm' => 'Restaurar este Contrato a su estado original?',
            ],
        ],
    ...
    */
    'crecursos' => [
        'access' => [
            'enterprise' => [
                'delete_confirm' => 'Estás seguro de querer eliminar esta Empresa de forma permanente? Esto puede producir un error grave en aquéllas partes de la aplicación que hagan referencia al mismo. Proceda con cautela. Esta operación no puede ser revertida.',
            ],
            'project' => [
                'delete_confirm' => 'Estás seguro de querer eliminar este Usuario de forma permanente? Esto puede producir un error grave en aquéllas partes de la aplicación que hagan referencia al mismo. Proceda con cautela. Esta operación no puede ser revertida.',
            ],
        ],
    ],
];
