...
namespace App\Http\Controllers\Cmovil\Access\Role;

use App\Models\Cmovil\Access\Role\Role;
use App\Http\Controllers\Controller;
use Yajra\Datatables\Facades\Datatables;
use App\Http\Requests\Cmovil\Access\Role\StoreRoleRequest;
use App\Http\Requests\Cmovil\Access\Role\ManageRoleRequest;
use App\Http\Requests\Cmovil\Access\Role\UpdateRoleRequest;
...
class RoleController extends Controller
{
	...
	{
        return view('cmovil.access.roles.index');
    }
    ...
    {
        return view('cmovil.access.roles.create')
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return redirect()->route('cmovil.access.role.index')->withFlashSuccess(trans('alerts.cmovil.roles.created'));
    }
    ...
    {
        return view('cmovil.access.roles.edit')
            ->withRole($role)
    ...
    public function update(Role $role, UpdateRoleRequest $request)
    {
        ...
        return redirect()->route('cmovil.access.role.index')->withFlashSuccess(trans('alerts.cmovil.roles.updated'));
    }
    ...
    public function destroy(Role $role, ManageRoleRequest $request)
    {
        ...
        return redirect()->route('cmovil.access.role.index')->withFlashSuccess(trans('alerts.cmovil.roles.deleted'));
    }
}