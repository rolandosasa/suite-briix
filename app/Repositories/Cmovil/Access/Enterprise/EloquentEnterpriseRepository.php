...
use App\Events\Cmovil\Access\Enterprise\EnterpriseCreated;
use App\Events\Cmovil\Access\Enterprise\EnterpriseDeleted;
use App\Events\Cmovil\Access\Enterprise\EnterpriseUpdated;
use App\Events\Cmovil\Access\Enterprise\EnterpriseRestored;
use App\Events\Cmovil\Access\Enterprise\EnterprisePermanentlyDeleted;
...
class EloquentEnterpriseRepository implements EnterpriseRepositoryContract
{
    ...
    public function create($input)
    {
        ...
        DB::transaction(function() use ($enterprise) {
            ...
            throw new GeneralException(trans('exceptions.Cmovil.access.enterprises.create_error'));
        });
    }
    ...
    public function update(Enterprise $enterprise, $input)
    {
        DB::transaction(function() use ($enterprise, $input) {
            ...
            throw new GeneralException(trans('exceptions.Cmovil.access.enterprises.update_error'));
        });
    }
    ...
    public function destroy(Enterprise $enterprise)
    {
        ...
        throw new GeneralException(trans('exceptions.Cmovil.access.enterprises.delete_error'));
    ...
    public function restore(Enterprise $enterprise)
    {
        ...
        throw new GeneralException(trans('exceptions.Cmovil.access.users.restore_error'));
    }
